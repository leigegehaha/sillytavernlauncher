export default {
  ...
  deepseek: {
    title: 'Tavern Exclusive Model',
    subtitle: 'DeepSeek Tavern Pro - Purpose-built LLM for Roleplay',
    registerBtn: 'Register Tavern Model',
    registerDesc: 'Visit deepseektavern.com to register and get an API key',
    features: 'Powerful AI roleplay experience with literary quality and immersive storytelling',
  },
  home: {
    ...
    startDesc: 'Pre-bundled latest Tavern, no setup needed',
    stopDesc: 'Click to safely shut down Tavern and related services',
    checkingUpdate: 'Checking for updates...',
    hasUpdate: 'New version available',
    isLatest: 'Already up to date',
    updating: 'Updating...',
    updateNow: 'Update Tavern',
    bundledVersion: 'Bundled Version',
    bundledVersionDesc: 'Latest Tavern included, ready to use',
    latestOnline: 'Latest Online Version',
  ...
  resources: {
    ...
    presets: {
      ...
      reasoning: 'Reasoning',
      all: 'All',
      noPresets: 'No preset files found',
      noPresetsHint: 'Please import .json preset files',
      addPreset: 'Import Preset',
      importSuccessMsg: 'Successfully imported preset {name}',
      totalPresets: 'Total {count}',
      confirmDelete: 'Delete preset "{name}"?',
    },
    regex: {
      title: 'Regex',
      noScripts: 'No regex scripts found',
      noScriptsHint: 'Please import .json or .js regex script files',
      addRegex: 'Import Regex',
      importSuccessMsg: 'Successfully imported regex script {name}',
      totalScripts: 'Total {count}',
    },
    migrate: {
